...
private actor RuntimeRecordingFake {
    ...
    private func didRead(id: String) -> IOSDebugRuntime.RecordingArtifact {
        fileIDs.append(id)
...
@Test @MainActor func configurationRejectsInvalidValues() throws {
    #expect(throws: ProtocolError.self) { try IOSDebugRuntime.Configuration(port: 0) }
    #expect(throws: ProtocolError.self) { try IOSDebugRuntime.Configuration(bearerToken: "") }
    #expect(throws: ProtocolError.self) { try IOSDebugRuntime.Configuration(maximumRecordingDuration: .zero) }
    #expect(throws: ProtocolError.self) { try IOSDebugRuntime.Configuration(maximumRecordingDuration: .seconds(601)) }
}
